                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h1 class="m-0">Thêm mới Product</h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="tel" class="form-control" id="overview"
                                        placeholder="Enter Price Regular" name="price_regular">
                                </div>

                                <div class="mb-3 mt-3">
                                    <label for="price_sale" class="form-label">Price Sale:</label>
                                    <input type="tel" class="form-control" id="price_sale" rows="4"
                                        placeholder="Enter Price Sale" name="price_sale">
                                </div>
