                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h1 class="m-0">Cập nhật: {{ $product['name'] }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ url("admin/products/{$product['id']}/update") }}" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="tel" class="form-control" id="overview" placeholder="Enter Price Regular"
                            ...
                            <div class="mb-3
                                ...
                                <input type="tel" class="form-control" id="price_sale" rows="4"
                                    placeholder="Enter Price Sale" name="price_sale" value="{{ $product['price_sale'] }}">
                            </div>
                        </div>
